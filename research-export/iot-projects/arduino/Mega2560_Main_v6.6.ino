 ...
 *  TOUCH_SENSOR      A2  (TTP223 Self-Locking)
 * ============================================= */
...
// ★ حساس اللمس TTP223 =====
const int touchSensorPin = A2;   // ★ تم تغييره من 26 إلى A2
...
void setup()
{
  ...
  lcd.setCursor(1, 0);
  lcd.print("Smart Parking v6.6");
  lcd.setCursor(2, 1);
  lcd.print("+ Safety System");
  lcd.setCursor(0, 2);
  lcd.print("Touch: A2 OK");
  delay(2500);
  lcd.clear();
}
...
void readTouchSensor()
{
  ...
  {
    // debounce: نتجاهل التغييرات السريعة (500ms)
