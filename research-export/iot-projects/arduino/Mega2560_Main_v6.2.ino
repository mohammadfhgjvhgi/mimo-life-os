/* =============================================
 *  Smart Parking + Safety System  v6.2  (BUFFER FIX)
...
const unsigned long SEND_INTERVAL = 1500;  // <-- 1.5 ثانية بدل 1 ثانية
...
void loop()
{
  ...
  // 6. ★★★ إرسال البيانات - ينتظر لو فيه أمر واصل ★★★
  sendDataToBridge();

  delay(30);  // <-- 30ms بدل 50ms (أسرع شوي في استقبال الأوامر)
}
...
{
  // ★★★ مهم: لو فيه أمر واصل - لا ترسل بيانات الحساسات ★★★
  // هذا يمنع التصادم بين بيانات الحساسات والأوامر على Serial1
