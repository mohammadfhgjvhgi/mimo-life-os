> For the complete documentation index, see [llms.txt](https://doc.anytype.io/anytype/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://doc.anytype.io/anytype/data/privacy-and-encryption.md).
...
* **Local key generation.** Your cryptographic [Key](/anytype/basics/key.md) is generated locally on your device when you create your [Vault](/anytype/basics/vault.md). It's never transmitted over the internet or stored on Anytype's servers — only you have it.
...
```
GET https://doc.anytype.io/anytype/data/privacy-and-encryption.md?ask=<question>&goal=<endgoal>
```
