> For the complete documentation index, see [llms.txt](https://doc.anytype.io/anytype/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://doc.anytype.io/anytype/features/inline-queries.md).
...
<div data-with-frame="true"><figure><img src="/files/DcsapDS53PEiwKDTPVps" alt=""><figcaption></figcaption></figure></div>
...
<figure><img src="/files/pYNo8RMYsP0Wq2MyKuX4" alt=""><figcaption></figcaption></figure>

### Dynamic filter values

Inline Queries pair beautifully with [dynamic filter values](/anytype/features/advanced-filters.md). Two especially useful values:
...
```
GET https://doc.anytype.io/anytype/features/inline-queries.md?ask=<question>&goal=<endgoal>
```
