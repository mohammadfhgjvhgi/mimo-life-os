> For the complete documentation index, see [llms.txt](https://doc.anytype.io/anytype/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://doc.anytype.io/anytype/resources/memberships.md).
...
```
GET https://doc.anytype.io/anytype/resources/memberships.md?ask=<question>&goal=<endgoal>
```
