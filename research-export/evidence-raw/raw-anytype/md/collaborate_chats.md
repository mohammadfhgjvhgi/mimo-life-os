> For the complete documentation index, see [llms.txt](https://doc.anytype.io/anytype/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://doc.anytype.io/anytype/collaborate/chats.md).
...
<div data-with-frame="true"><figure><img src="/files/dilfYoehyVwvD2nvyBuf" alt=""><figcaption></figcaption></figure></div>

## How it works

Just like documents and files, Chats are [Objects](/anytype/create/objects.md) that have their own dedicated [Type](/anytype/organize/types.md). This means that a Chat:

* Lives in the Types section of the Sidebar under 'Chat'.
* Can have its own [Properties](/anytype/organize/properties.md).
* Can be organized into [Views](/anytype/organize/views.md), [Queries](/anytype/organize/queries.md), and [Collections](/anytype/organize/collections.md).
* Can be added as a [Widget](/anytype/basics/sidebar/widgets.md) to the Sidebar.
...
<div data-with-frame="true"><figure><img src="/files/K6YYu3vBAeAn1zQlWQZ3" alt=""><figcaption></figcaption></figure></div>
...
A single Channel can hold multiple Chats. You can start topic-specific conversations right where the work happens and keep them organized by using [Views](/anytype/organize/views.md).
...
<div data-with-frame="true"><figure><img src="/files/iQloLCts9Rls8rRM5tgB" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/0Od3uRiNPr9PEQqBmfk9" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/RIcRvY7DioDfL9HEpz4V" alt=""><figcaption></figcaption></figure></div>
...
A temporary **Unread** section appears automatically when new messages arrive in any Chat. As you catch up, the section shrinks and eventually disappears. This section also displays notifications from [Discussions](/anytype/collaborate/discussions.md). Learn more in the [Sidebar](/anytype/basics/sidebar/sections.md) section.

<div data-with-frame="true"><figure><img src="/files/TxjaxhdyBQuWvmWdrcEx" alt=""><figcaption></figcaption></figure></div>
...
See [Channels](/anytype/basics/channels.md#choosing-a-home) for more details.

<div data-with-frame="true"><figure><img src="/files/DRwlgVEK93sBIqNstGPg" alt=""><figcaption></figcaption></figure></div>
...
For one-on-one conversations with others, use **Direct Channels** — private chats between two people, with no admin or hierarchy. See [Direct Channels](/anytype/collaborate/chats/direct-channels.md) for more information.
...
```
GET https://doc.anytype.io/anytype/collaborate/chats.md?ask=<question>&goal=<endgoal>
```
