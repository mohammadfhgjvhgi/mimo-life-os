> For the complete documentation index, see [llms.txt](https://doc.anytype.io/anytype/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://doc.anytype.io/anytype/collaborate/collaboration.md).
...
<div data-with-frame="true"><figure><img src="/files/8XUiBD2cL5GubDtCzY9X" alt=""><figcaption></figcaption></figure></div>
...
<div><figure><img src="/files/21S9Zsnsa6UStU0EV3Ui" alt=""><figcaption><p>Typical Cloud App Sync</p></figcaption></figure> <figure><img src="/files/RcCVRTBBVoeoRtd96FGt" alt=""><figcaption><p>Anytype Local-first Sync</p></figcaption></figure></div>

## Inviting and joining

1. Open [Channel Settings](/anytype/settings/channel-settings.md) by clicking the Channel name in the Sidebar.
2. Click on the Members section.
3. Choose your invitation method — availability is set by the Space Owner.

<div data-with-frame="true"><figure><img src="/files/xG3B6tm8kki5OJgIlWwF" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/XN5cfzu2XSiSAlS7ofG4" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/3fns83hSYkEuvFMxjc5C" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/AEV7nLJRAsRgLUYdInte" alt=""><figcaption></figcaption></figure></div>

#### Editor seat limits

Each Channel has a maximum number of Editors based on the Owner's plan. The default Free tier supports a small number of Editors per Channel. Higher-tier plans (Builder, Co-Creator, Ultra, Group memberships) increase this limit. See [Memberships](/anytype/resources/memberships.md).
...
For more sensitive, high-security cases, use **self-hosted** networks where you control the relay nodes. See [Networks & Backup](/anytype/data/sync-and-backup.md). You can also use **local-only** mode for fully air-gapped sharing on a local network.
...
<div data-with-frame="true"><figure><img src="/files/uwdPwS1Nh2DaYennb5ub" alt=""><figcaption></figcaption></figure></div>
...
{% hint style="warning" %}
**Currently, you can only share entire Channels — not individual Objects.** If you want to share just one thing publicly with no access controls, use [Web Publishing](/anytype/collaborate/publish.md) instead.
{% endhint %}
...
```
GET https://doc.anytype.io/anytype/collaborate/collaboration.md?ask=<question>&goal=<endgoal>
```
