> For the complete documentation index, see [llms.txt](https://doc.anytype.io/anytype/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://doc.anytype.io/anytype/features/advanced-filters.md).
...
<figure><img src="/files/Kj40SfP4NgFOCEsRGhUl" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/18NLK4ShxrtRNEyAv1R4" alt=""><figcaption></figcaption></figure>
...
**This Object** works inside [Inline Lists](/anytype/features/inline-queries.md) — it scopes the inline Query/Collection to whatever Object is hosting it.
...
```
GET https://doc.anytype.io/anytype/features/advanced-filters.md?ask=<question>&goal=<endgoal>
```
