> For the complete documentation index, see [llms.txt](https://doc.anytype.io/anytype/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://doc.anytype.io/anytype/organize/properties.md).
...
<div data-with-frame="true"><figure><img src="/files/y850xzfcrl3Rokh2NKxY" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/nWiZIUbZHGjg9B4K5pHu" alt=""><figcaption></figcaption></figure></div>
...
* Properties on Objects can exist independently from [Types](/anytype/organize/types.md). Think of Types as a group of Properties that all get applied to an Object at the same time.
...
Because all [Objects](/anytype/create/objects.md) have a [Type](/anytype/organize/types.md), it's best to use Properties within the context of a Type. You can:
...
[While editing a Type](/anytype/organize/types.md#editing-types), you can use the 'plus' button of the Properties section to add an existing Property or create a new one. To edit a Property, simply click on it. To rearrange the order, click and drag the handle on the left-hand side.

<div data-with-frame="true"><figure><img src="/files/aO9HxrjzfyC2FWNme4Du" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/lQBXxuIWTHNtMrvPAvm3" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/VC12JBLwF3SKGOOnNdWA" alt=""><figcaption></figcaption></figure></div>

#### From Channel Settings

Open your [Channel Settings](/anytype/settings/channel-settings.md), and navigate to Content Model and select **Properties**. Afterwards, simply click on 'New' button to create a new Property.

## Using Properties

Properties are best used in context with their Type. You can manage Properties from the 'Edit Type' panel—[see here](/anytype/organize/types.md#editing-types).

### Properties in Views

Properties are most powerful in [Views](/anytype/organize/views.md), which offer flexible, customizable ways to interact with your knowledge. To learn more, please see the [Views](/anytype/organize/views.md) section.
...
<div data-with-frame="true"><figure><img src="/files/hNiJwo0mtZ3WXkZ5WI7p" alt=""><figcaption></figcaption></figure></div>
...
Properties that are not seen in the Header can still be part of the Type, which are typically used in [Views](/anytype/organize/views.md).
...
Once inserted as a block, you can manipulate the Property just like any other block. This is particularly helpful if you want to design nice [Templates](/anytype/organize/templates.md), as the Object Header is more limited in design flexibility.

<div data-with-frame="true"><figure><img src="/files/a5OrOvhLzFVPMeuZviTl" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/1oR8llO7ZKydxgjIKXkT" alt=""><figcaption></figcaption></figure></div>

## Deleting Properties

Properties exist independently from [Types](/anytype/organize/types.md) and [Objects](/anytype/create/objects.md)—they are their own thing. Because of this, there are multiple ways to remove them.

#### From a Type

1. [Navigate to the Type](/anytype/organize/types.md#editing-types) that you want to remove the Property from.
...
<div data-with-frame="true"><figure><img src="/files/OWsGHf6gQKsyfNzI0CgT" alt=""><figcaption></figcaption></figure></div>
...
1. Navigate to the [Channel Settings](/anytype/settings/channel-settings.md) from the Sidebar.
...
<div data-with-frame="true"><figure><img src="/files/d4vl0y0i2RQ9e29qlYmK" alt=""><figcaption></figcaption></figure></div>
...
{% hint style="info" %}
**Tags is the easiest way to get started with Properties.** Add relevant tags to all of your documents and create a [Query](/anytype/organize/queries.md) that groups them all together.
{% endhint %}
...
```
GET https://doc.anytype.io/anytype/organize/properties.md?ask=<question>&goal=<endgoal>
```
