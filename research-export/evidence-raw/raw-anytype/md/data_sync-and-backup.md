> For the complete documentation index, see [llms.txt](https://doc.anytype.io/anytype/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://doc.anytype.io/anytype/data/sync-and-backup.md).
...
To ensure you never lose your data, the Anytype Network keeps an encrypted remote backup. Only your private key can decrypt and restore it to a new device — nobody else, not even Anytype, can access your encrypted data. Being in complete control also means you are fully responsible for your [keys](/anytype/basics/key.md) to access and recover your data.
{% endstep %}
{% endstepper %}

Anytype provides a convenient safe haven for your digital life. Learn more about collaboration in [Collaboration](/anytype/collaborate/collaboration.md).

<div data-with-frame="true"><figure><img src="/files/RcCVRTBBVoeoRtd96FGt" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/L0D72efGmiKYV0bt7SwE" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/QXykbf86ntsRcRVde5vp" alt="" width="375"><figcaption></figcaption></figure></div>

## Alternative sync methods

Anytype also supports two alternative modes:

* [Self-host](/anytype/data/sync-and-backup/self-host.md) — use your own infrastructure to host and sync your Anytype data.
* [Local-only](/anytype/data/sync-and-backup/local-only.md) — don't sync through any server at all; your data stays on-device.
...
{% hint style="danger" %}
**Do not use network drives or third-party services for sync**—this will likely cause data corruption. [Learn more here](/anytype/data/sync-and-backup/local-only.md#third-party-services-and-network-drives).&#x20;
{% endhint %}
...
```
GET https://doc.anytype.io/anytype/data/sync-and-backup.md?ask=<question>&goal=<endgoal>
```
