> For the complete documentation index, see [llms.txt](https://doc.anytype.io/anytype/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://doc.anytype.io/anytype/basics/key.md).
...
To find your Key in your [Vault Settings](/anytype/settings/vault-settings.md):
...
* You can also try recovering your Key from your [OS Key storage manager](/anytype/resources/faq.md#how-to-recover-my-key-from-my-os-key-storage-manager).
...
```
GET https://doc.anytype.io/anytype/basics/key.md?ask=<question>&goal=<endgoal>
```
