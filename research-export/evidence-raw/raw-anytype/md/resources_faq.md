> For the complete documentation index, see [llms.txt](https://doc.anytype.io/anytype/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://doc.anytype.io/anytype/resources/faq.md).
...
Pin to Channel is available only to owners of the space. In order to add your own Widgets when you're not an owner, use the Favorites feature with the star icon. These Favorites in the Sidebar only appear to you. If your Pins or Favorites are not appearing as Widgets, you may need to change the Channel Settings. [Learn more](broken://spaces/uI82XLdf1100Q75OKbEQ/pages/2fFLgPPcgugapXstKXit#widget-settings).
...
Click and drag the 'handle' to the left of each block and move it to your desired location. [Learn more](broken://spaces/uI82XLdf1100Q75OKbEQ/pages/kKMvdjkyPuslLTe0ciuD#columns).

<figure><img src="/files/1jbHqA2KKuJFlD4ndSi3" alt=""><figcaption></figcaption></figure>
...
Anytype does not have access to your account in any way, thus we do not have your Key and cannot recover it for you. However you may be able to recover it on your own, [see here for more details](broken://spaces/uI82XLdf1100Q75OKbEQ/pages/da9Vb7031YFOGlVpu4Ui#if-youve-lost-your-key).
...
* Columns
* Inline LaTeX
* [Inline Views](/anytype/features/inline-queries.md)
* Kanban, Calendar, and Graph Views
* [Formulas](/anytype/features/formulas.md)
* [Embeds](/anytype/features/embeds.md)
* [Custom CSS](/anytype/features/custom-css.md)
* [Storage Location](/anytype/features/storage-location.md)
* [Graph](/anytype/features/graph.md) & Flow
* [Import & Export](/anytype/data/import-and-export.md)
* PIN Code
...
Vaults created before version 0.44.0 have an Entry Space. You are free to delete this channel if no longer needed, or you can migrate your data to a different channel by using the [Import & Export](/anytype/data/import-and-export.md) feature.
...
```
GET https://doc.anytype.io/anytype/resources/faq.md?ask=<question>&goal=<endgoal>
```
